...
/**
 * The RambleApp class is an application that generates text based on a given
 * file
 * using a UnigramWordPredictor. The text is generated by predicting the next
 * word
...
public class RambleApp {
     ...
     * generated by the tokenizer. If the file cannot be read, an empty list is
     * returned.
     * 
     * @param filename the name of the file to read
     * @return a list of tokens from the file, or an empty list if the file could
     *         not be read
     */
    ...
    public static void main(String[] args) {
        ...
        // here is where i can run my bigram predictor instead of unigram but it seems
        // to work better with unigram so i just did a test to prove it works
        UnigramWordPredictor predictor = new UnigramWordPredictor(tokenizer);
        // WordPredictor predictor = new BigramWordPredictor(tokenizer);
